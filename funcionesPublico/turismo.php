        ...
        <div class="row row-grid align-items-center">
            ...
            <div class="col-md-6">
                <div class="pl-md-5">
                    <div class="rounded shadow-lg overflow-hidden transform-perspective-left">
                        <div id="carousel_<?= $id ?>" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#carousel_<?= $id ?>" data-slide-to="0" class="<?php if($turismo->getFoto1() != ""){echo 'active';} ?>" ></li>
                                <?php } ?>
                                <?php if($turismo->getFoto2() != "") { ?>
                                <li data-target="#carousel_<?= $id ?>" data-slide-to="1" class="<?php if($turismo->getFoto1() == ""){echo 'active';} ?>" ></li>
                                <?php } ?>
                                <?php if($turismo->getFoto3() != "") { ?>
                                <li data-target="#carousel_<?= $id ?>" data-slide-to="2" class="<?php if($turismo->getFoto2() == ""  ){echo 'active';} ?>" ></li>
                                <?php } ?>
                                
                            </ol>
                            <div class="carousel-inner">
                                <?php if($turismo->getFoto1() != "") { ?>
                                <div class="carousel-item <?php if($turismo->getFoto1() != ""){echo 'active';} ?>">
                                ...
                                <?php } else ?>
                                <?php if($turismo->getFoto3() != "") { ?>
                                <div class="carousel-item <?php if($turismo->getFoto2() == ""  ){echo 'active';} ?> ">
                    ...
                    <a href="<?= $turismo->getFacebook(); ?>" target="_black" class="btn btn-icon btn-2 btn-primary" >
                        <span class="btn-inner--icon"><i class="ni ni-atom fa fa-facebook"></i></span>
                    </a>
                    <?php } ?>
                    <?php if($turismo->getTwiter() != ""){ ?>
                    <a href="<?= $turismo->getTwiter(); ?>" target="_black" class="btn btn-icon btn-2 btn-info" >
                        <span class="btn-inner--icon"><i class="ni ni-atom fa fa-twitter"></i></span>
                    </a>
                    <?php } ?>
                    <?php if($turismo->getInstagram() != ""){ ?>
                    <a href="<?= $turismo->getInstagram(); ?>" target="_black" class="btn btn-icon btn-2 btn-danger" >
                        <span class="btn-inner--icon"><i class="ni ni-atom fa fa-instagram"></i></span>
                    </a>
                    <?php } ?>
                    <?php if($turismo->getPagina() != ""){ ?>
                    <a href="<?= $turismo->getPagina() ?>" target="_black" class="btn btn-icon btn-2 btn-primary" >
                        <span class="btn-inner--icon">Página web</span>
                    </a>
                    <?php } ?>
